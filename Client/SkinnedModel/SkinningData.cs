...
namespace SkinnedModel
{
    ...
    public class SkinningData
    {
        ...
        public SkinningData(Dictionary<string, AnimationClip> animationClips,
                            ...
                            List<int> skeletonHierarchy, List<Matrix> originalAbsoluteTransforms)
        {
            AnimationClips = animationClips;
            BindPose = bindPose;
            InverseBindPose = inverseBindPose;
            SkeletonHierarchy = skeletonHierarchy;
            OriginalAbsoluteTransforms = originalAbsoluteTransforms;
        }
        ...
        [ContentSerializer]
        public List<Matrix> OriginalAbsoluteTransforms { get; private set; }
