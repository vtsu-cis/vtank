...
namespace SkinnedModelPipeline
{
    ...
    public class SkinnedModelProcessor : ModelProcessor
    {
                                             ...
                                             ContentProcessorContext context)
        {
            ...
            List<Matrix> originalAbsoluteTransforms = new List<Matrix>();
            CopyAbsoluteTransformsTo(input, ref originalAbsoluteTransforms);
            ...
            model.Tag = new SkinningData(animationClips, bindPose,
                                         inverseBindPose, skeletonHierarchy, originalAbsoluteTransforms);

            return model;
        }

        /// <summary>
        /// Copies the bone transforms to a matrix array
        /// </summary>
        /// <param name="input">The node to process</param>
        /// <param name="output">The matix array.</param>
        void CopyAbsoluteTransformsTo(NodeContent input, ref List<Matrix> output)
        {
            output.Add(input.AbsoluteTransform);
            foreach (NodeContent child in input.Children)
            {
                CopyAbsoluteTransformsTo(child, ref output);
            }
        }
