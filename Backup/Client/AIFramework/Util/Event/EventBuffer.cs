namespace AIFramework.Util.Event
{
    ...
    public class EventBuffer
    {
        ...
        /// <summary>
        /// Pushes a new event onto the event queue, meaning it falls on the end of the stack.
        /// This will be later processed through Pop().
        /// </summary>
        /// <param name="eventToBuffer"></param>
        /// <exception cref="System.ArgumentNullException"></exception>
        public void Push(IEvent eventToBuffer)
        {
