...
NoDotNET:
  MessageBox MB_ICONINFORMATION|MB_OK "No .NET found. Downloading and Installing from Microsoft"
  goto DownloadDotNET ;IDCANCEL
	
OldDotNET:
  MessageBox MB_ICONINFORMATION|MB_OK "Old .NET found. Downloading and Installing updated version from Microsoft"
  goto DownloadDotNET ;IDCANCEL
